...
const AddPassword = () => {
  ...
  return (
    ...
    <CustomBox6>
      ...
      <Typography variant="h6" sx={{ marginBottom: '10px',color:'#fff' }}>User Name </Typography>
        ...
        <Typography variant="h6" sx={{ marginBottom: '10px',color:'#fff' }}>Email</Typography>
        ...
        <Typography variant="h6" sx={{ marginBottom: '10px',color:'#fff' }}>Number</Typography>
        ...
        <StyledTextField  variant="outlined" fullWidth value={password} onChange={handlePasswordChange} type="password" InputProps={{ style: { fontFamily: 'Arial' } }} />
        <Typography variant="h6" sx={{ marginBottom: '10px',color:'#fff' }}>Confirm Password</Typography>
        <StyledTextField  variant="outlined" fullWidth value={password} onChange={handlePasswordChange} type="password" InputProps={{ style: { fontFamily: 'Arial' } }} />
